...
using healthtest2.Core.Helpers;
using healthtest2.Core.Models;
using healthtest2.Core.Services;
using healthtest2.Helpers;
using healthtest2.Models;

using Windows.Storage;

namespace healthtest2.Services
{
