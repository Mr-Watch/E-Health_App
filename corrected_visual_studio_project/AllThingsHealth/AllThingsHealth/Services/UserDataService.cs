...
using AllThingsHealth.Core.Helpers;
using AllThingsHealth.Core.Models;
using AllThingsHealth.Core.Services;
using AllThingsHealth.Helpers;
using AllThingsHealth.Models;

using Windows.Storage;

namespace AllThingsHealth.Services
{
