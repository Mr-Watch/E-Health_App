...
# url = "https://doctor.vrisko.gr/patients/registerappointmentstep1.aspx/GetVriskoObjects"
...
def make_post_request_api():
  data = """
      {"id": "2351", "webmdid": "1050", "focus": true, "bodyid": 601},
      {"id": "3694", "webmdid": "4806", "bodyid": 601},
      {"id": "640", "webmdid": "1627", "bodyid": 601}
      """
  response = requests.post('127.0.0.1:5000/ath/api/v0.1/webmd/conditions/22/male', data=data)
  print(response.json())

make_post_request_api()